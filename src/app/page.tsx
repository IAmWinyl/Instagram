  ...
  return (
    <>
      <main
        ...
        role="main"
      >
        <article className="flex flex-row grow shrink-0 max-w-[--polaris-site-width-wide] w-full mt-8 pb-8 justify-center mx-auto align-top">
          <div className="self-center pt-[27px] h-[581.15px] mb-3 bg-[length:468.32px_634.15px] bg-[-46px_0px] basis-[380.32px] mr-8 bg-[url(https://static.cdninstagram.com/images/instagram/xig/homepage/phones/home-phones-2x.png?__makehaste_cache_breaker=73SVAexZgBW)]">
          ...
          <div className="flex flex-col grow shrink-0 justify-center mt-[12px] max-w-[350px]">
            <div className="flex flex-col bg-primary_background border-[1px] border-elevated_separator items-center box-border mb-[10px] py-[10px] relative text-primary_text">
              ...
              />
              <div className="flex flex-col max-w-[350px] mb-[12px] w-full">
                <SignInForm />
              </div>
            </div>
