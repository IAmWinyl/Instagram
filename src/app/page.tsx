  ...
  return (
    <div className="flex flex-col">
      <div className="flex flex-col grow justify-center mt-[12px] max-w-[350px]">
        <div className="flex flex-col shrink-0 bg-primary_background border-[1px] items-center border-elevated_separator box-border mb-[10px] py-[10px] relative text-primary_text">
          <button
            type="button"
